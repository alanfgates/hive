...
import org.apache.hadoop.hive.metastore.api.CatalogName;
...
public interface IMetaStoreClient {
   ...
   * @throws TException general thrift exception.
   */
  Catalog getCatalog(CatalogName catName) throws NoSuchObjectException, MetaException, TException;

  /**
   * Get a catalog object.
   * @param catName catalog name, as a string.
   * @return the catalog.
   * @throws NoSuchObjectException no catalog of this name exists.
   * @throws MetaException something went wrong, usually in the database.
   * @throws TException general thrift exception.
   */
  default Catalog getCatalog(String catName)
      throws NoSuchObjectException, MetaException, TException {
    return getCatalog(new CatalogName(catName));
  }
   ...
   * @throws TException general thrift exception.
   */
  void dropCatalog(CatalogName catName)
      throws NoSuchObjectException, InvalidOperationException, MetaException, TException;

  /**
   * Drop a catalog.  Catalogs must be empty to be dropped, there is no cascade for dropping a
   * catalog.
   * @param catName name of the catalog to drop, as a string
   * @throws NoSuchObjectException no catalog of this name exists.
   * @throws InvalidOperationException The catalog is not empty and cannot be dropped.
   * @throws MetaException something went wrong, usually in the database.
   * @throws TException general thrift exception.
  ...
  default void dropCatalog(String catName)
      throws NoSuchObjectException, InvalidOperationException, MetaException, TException {
    dropCatalog(new CatalogName(catName));
  }
