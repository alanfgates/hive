...
public class ObjectStore implements RawStore, Configurable {
  ...
  */
  ...
  public void createDatabase(Database db) throws InvalidObjectException, MetaException {
    ...
    mdb.setCatalogName(db.getCatalogName());
...
*/
  ...
  */
  ...
  public List<ColStatsObjWithSourceInfo> getPartitionColStatsForDatabase(String catName, String dbName)
    ...
    return new GetHelper<List<ColStatsObjWithSourceInfo>>(catName, dbName, null, true, false) {
      @Override
  ...
  private List<SQLForeignKey> getForeignKeysViaJdo(String catName, String parent_db_name,
    ...
    try {
      ...
      String queryText = (parent_tbl_name != null ? "parentTable.tableName == parent_tbl_name && " : "")
        + " parentTable.database.catalogName == catName && childTable.database.catalogName == catName  && "
      ...
      String paramText = "java.lang.String catName" +
