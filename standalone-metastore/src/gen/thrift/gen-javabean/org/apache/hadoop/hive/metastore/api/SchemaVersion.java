            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.cols = new ArrayList<FieldSchema>(_list738.size);
                FieldSchema _elem739;
                for (int _i740 = 0; _i740 < _list738.size; ++_i740)
                {
                  _elem739 = new FieldSchema();
                  _elem739.read(iprot);
                  struct.cols.add(_elem739);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SchemaVersion struct) throws org.apache.thrift.TException {
      ...
      if (struct.cols != null) {
        oprot.writeFieldBegin(COLS_FIELD_DESC);
        {
          ...
          for (FieldSchema _iter741 : struct.cols)
          {
      ...
      if (struct.isSetCols()) {
        {
          ...
          for (FieldSchema _iter742 : struct.cols)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.cols = new ArrayList<FieldSchema>(_list743.size);
          FieldSchema _elem744;
          for (int _i745 = 0; _i745 < _list743.size; ++_i745)
          {
            _elem744 = new FieldSchema();
            _elem744.read(iprot);
            struct.cols.add(_elem744);
          }
        }
        struct.setColsIsSet(true);
      }
