            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.schemaVersions = new ArrayList<FindSchemasByColsRespEntry>(_list746.size);
                FindSchemasByColsRespEntry _elem747;
                for (int _i748 = 0; _i748 < _list746.size; ++_i748)
                {
                  _elem747 = new FindSchemasByColsRespEntry();
                  _elem747.read(iprot);
                  struct.schemaVersions.add(_elem747);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FindSchemasByColsResp struct) throws org.apache.thrift.TException {
      ...
      if (struct.schemaVersions != null) {
        oprot.writeFieldBegin(SCHEMA_VERSIONS_FIELD_DESC);
        {
          ...
          for (FindSchemasByColsRespEntry _iter749 : struct.schemaVersions)
          {
      ...
      if (struct.isSetSchemaVersions()) {
        {
          ...
          for (FindSchemasByColsRespEntry _iter750 : struct.schemaVersions)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.schemaVersions = new ArrayList<FindSchemasByColsRespEntry>(_list751.size);
          FindSchemasByColsRespEntry _elem752;
          for (int _i753 = 0; _i753 < _list751.size; ++_i753)
          {
            _elem752 = new FindSchemasByColsRespEntry();
            _elem752.read(iprot);
            struct.schemaVersions.add(_elem752);
          }
        }
        struct.setSchemaVersionsIsSet(true);
      }
