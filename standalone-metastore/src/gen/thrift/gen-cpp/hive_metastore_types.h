...
typedef struct _SQLPrimaryKey__isset {
  _SQLPrimaryKey__isset() : table_db(false), table_name(false), column_name(false), key_seq(false), pk_name(false), enable_cstr(false), validate_cstr(false), rely_cstr(false), catName(true) {}
  bool table_db :1;
  bool table_name :1;
  bool column_name :1;
  bool key_seq :1;
...
class SQLPrimaryKey {
 public:
  ...
  SQLPrimaryKey() : table_db(), table_name(), column_name(), key_seq(0), pk_name(), enable_cstr(0), validate_cstr(0), rely_cstr(0), catName("hive") {
  }
...
typedef struct _SQLForeignKey__isset {
  _SQLForeignKey__isset() : pktable_db(false), pktable_name(false), pkcolumn_name(false), fktable_db(false), fktable_name(false), fkcolumn_name(false), key_seq(false), update_rule(false), delete_rule(false), fk_name(false), pk_name(false), enable_cstr(false), validate_cstr(false), rely_cstr(false), catName(true) {}
  bool pktable_db :1;
  bool pktable_name :1;
...
class SQLForeignKey {
 public:
  ...
  SQLForeignKey() : pktable_db(), pktable_name(), pkcolumn_name(), fktable_db(), fktable_name(), fkcolumn_name(), key_seq(0), update_rule(0), delete_rule(0), fk_name(), pk_name(), enable_cstr(0), validate_cstr(0), rely_cstr(0), catName("hive") {
  }
...
typedef struct _HiveObjectRef__isset {
  _HiveObjectRef__isset() : objectType(false), dbName(false), objectName(false), partValues(false), columnName(false), catName(true) {}
  bool objectType :1;
  bool dbName :1;
  bool objectName :1;
  bool partValues :1;
...
class HiveObjectRef {
 public:
  ...
  HiveObjectRef() : objectType((HiveObjectType::type)0), dbName(), objectName(), columnName(), catName("hive") {
  }
...
typedef struct _CatalogName__isset {
  _CatalogName__isset() : name(false) {}
  bool name :1;
} _CatalogName__isset;
...
class CatalogName {
 public:
  ...
  CatalogName(const CatalogName&);
  CatalogName& operator=(const CatalogName&);
  CatalogName() : name() {
  }

  virtual ~CatalogName() throw();
  std::string name;

  _CatalogName__isset __isset;

  void __set_name(const std::string& val);

  bool operator == (const CatalogName & rhs) const
  {
    if (!(name == rhs.name))
      return false;
    return true;
  ...
  bool operator < (const CatalogName & ) const;
...
inline std::ostream& operator<<(std::ostream& out, const CatalogName& obj)
{
  obj.printTo(out);
  return out;
}
...
class Table {
 public:
  ...
  Table() : tableName(), dbName(), owner(), createTime(0), lastAccessTime(0), retention(0), viewOriginalText(), viewExpandedText(), tableType(), temporary(false), rewriteEnabled(0), catName("hive") {
  }
...
typedef struct _Partition__isset {
  _Partition__isset() : values(false), dbName(false), tableName(false), createTime(false), lastAccessTime(false), sd(false), parameters(false), privileges(false), catName(true) {}
  bool values :1;
  bool dbName :1;
  bool tableName :1;
  bool createTime :1;
...
class Partition {
 public:
  ...
  Partition() : dbName(), tableName(), createTime(0), lastAccessTime(0), catName("hive") {
  }
...
typedef struct _PartitionSpec__isset {
  _PartitionSpec__isset() : dbName(false), tableName(false), rootPath(false), sharedSDPartitionSpec(false), partitionList(false), catName(true) {}
  bool dbName :1;
  bool tableName :1;
  bool rootPath :1;
...
class PartitionSpec {
 public:
  ...
  PartitionSpec() : dbName(), tableName(), rootPath(), catName("hive") {
  }
...
typedef struct _ColumnStatisticsDesc__isset {
  _ColumnStatisticsDesc__isset() : partName(false), lastAnalyzed(false), catName(true) {}
  bool partName :1;
  bool lastAnalyzed :1;
  bool catName :1;
...
class ColumnStatisticsDesc {
 public:
  ...
  ColumnStatisticsDesc() : isTblLevel(0), dbName(), tableName(), partName(), lastAnalyzed(0), catName("hive") {
  }
...
typedef struct _PrimaryKeysRequest__isset {
  _PrimaryKeysRequest__isset() : catName(true) {}
  bool catName :1;
...
class PrimaryKeysRequest {
 public:
  ...
  PrimaryKeysRequest() : db_name(), tbl_name(), catName("hive") {
  }
...
typedef struct _ForeignKeysRequest__isset {
  _ForeignKeysRequest__isset() : parent_db_name(false), parent_tbl_name(false), foreign_db_name(false), foreign_tbl_name(false), catName(true) {}
...
class ForeignKeysRequest {
 public:
  ...
  ForeignKeysRequest() : parent_db_name(), parent_tbl_name(), foreign_db_name(), foreign_tbl_name(), catName("hive") {
  }
...
typedef struct _DropConstraintRequest__isset {
  _DropConstraintRequest__isset() : catName(true) {}
  bool catName :1;
...
class DropConstraintRequest {
 public:
  ...
  DropConstraintRequest() : dbname(), tablename(), constraintname(), catName("hive") {
  }
...
typedef struct _PartitionsByExprRequest__isset {
  _PartitionsByExprRequest__isset() : defaultPartitionName(false), maxParts(true), catName(true) {}
...
class PartitionsByExprRequest {
 public:
  ...
  PartitionsByExprRequest() : dbName(), tblName(), expr(), defaultPartitionName(), maxParts(-1), catName("hive") {
  }
...
typedef struct _TableStatsRequest__isset {
  _TableStatsRequest__isset() : catName(true) {}
  bool catName :1;
...
class TableStatsRequest {
 public:
  ...
  TableStatsRequest() : dbName(), tblName(), catName("hive") {
  }
...
typedef struct _PartitionsStatsRequest__isset {
  _PartitionsStatsRequest__isset() : catName(true) {}
  bool catName :1;
...
class PartitionsStatsRequest {
 public:
  ...
  PartitionsStatsRequest() : dbName(), tblName(), catName("hive") {
  }
...
typedef struct _AddPartitionsRequest__isset {
  _AddPartitionsRequest__isset() : needResult(true), catName(true) {}
  bool needResult :1;
  bool catName :1;
...
class AddPartitionsRequest {
 public:
  ...
  AddPartitionsRequest() : dbName(), tblName(), ifNotExists(0), needResult(true), catName("hive") {
  }
...
typedef struct _DropPartitionsRequest__isset {
  _DropPartitionsRequest__isset() : deleteData(false), ifExists(true), ignoreProtection(false), environmentContext(false), needResult(true), catName(true) {}
  bool deleteData :1;
  bool ifExists :1;
...
class DropPartitionsRequest {
 public:
  ...
  DropPartitionsRequest() : dbName(), tblName(), deleteData(0), ifExists(true), ignoreProtection(0), needResult(true), catName("hive") {
  }
...
typedef struct _PartitionValuesRequest__isset {
  _PartitionValuesRequest__isset() : applyDistinct(true), filter(false), partitionOrder(false), ascending(true), maxParts(true), catName(true) {}
...
class PartitionValuesRequest {
 public:
  ...
  PartitionValuesRequest() : dbName(), tblName(), applyDistinct(true), filter(), ascending(true), maxParts(-1LL), catName("hive") {
  }
...
typedef struct _Function__isset {
  _Function__isset() : functionName(false), dbName(false), className(false), ownerName(false), ownerType(false), createTime(false), functionType(false), resourceUris(false), catName(true) {}
  bool functionName :1;
  bool dbName :1;
  bool className :1;
  bool ownerName :1;
...
class Function {
 public:
  ...
  Function() : functionName(), dbName(), className(), ownerName(), ownerType((PrincipalType::type)0), createTime(0), functionType((FunctionType::type)0), catName("hive") {
  }
...
typedef struct _NotificationEvent__isset {
  _NotificationEvent__isset() : dbName(false), tableName(false), messageFormat(false), catName(true) {}
  bool dbName :1;
  bool tableName :1;
...
class NotificationEvent {
 public:
  ...
  NotificationEvent() : eventId(0), eventTime(0), eventType(), dbName(), tableName(), message(), messageFormat(), catName("hive") {
  }
...
typedef struct _NotificationEventsCountRequest__isset {
  _NotificationEventsCountRequest__isset() : catName(true) {}
  bool catName :1;
...
class NotificationEventsCountRequest {
 public:
  ...
  NotificationEventsCountRequest() : fromEventId(0), dbName(), catName("hive") {
  }
...
typedef struct _GetTableRequest__isset {
  _GetTableRequest__isset() : capabilities(false), catName(true) {}
  bool capabilities :1;
  bool catName :1;
...
class GetTableRequest {
 public:
  ...
  GetTableRequest() : dbName(), tblName(), catName("hive") {
  }
...
typedef struct _GetTablesRequest__isset {
  _GetTablesRequest__isset() : tblNames(false), capabilities(false), catName(true) {}
  bool tblNames :1;
  bool capabilities :1;
  bool catName :1;
...
class GetTablesRequest {
 public:
  ...
  GetTablesRequest() : dbName(), catName("hive") {
  }
...
typedef struct _TableMeta__isset {
  _TableMeta__isset() : comments(false), catName(true) {}
  bool comments :1;
  bool catName :1;
} _TableMeta__isset;
...
class TableMeta {
 public:
  ...
  TableMeta() : dbName(), tableName(), tableType(), comments(), catName("hive") {
  }
