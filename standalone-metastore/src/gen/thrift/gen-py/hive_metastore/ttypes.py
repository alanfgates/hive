      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i654 in xrange(_size650):
            _elem655 = FieldSchema()
            _elem655.read(iprot)
            self.cols.append(_elem655)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
...
class FindSchemasByColsResp:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i661 in xrange(_size657):
            _elem662 = FindSchemasByColsRespEntry()
            _elem662.read(iprot)
            self.schemaVersions.append(_elem662)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.schemaVersions is not None:
      ...
      for iter663 in self.schemaVersions:
        iter663.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
