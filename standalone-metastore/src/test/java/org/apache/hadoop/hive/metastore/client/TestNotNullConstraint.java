...
public class TestNotNullConstraint {
  ...
  public void createGetDrop() throws TException {
    ...
    NotNullConstraintsRequest rqst =
        new NotNullConstraintsRequest(table.getDbName(), table.getTableName());
    ...
    rqst = new NotNullConstraintsRequest(table.getDbName(), table.getTableName());
    rqst.setCatName(table.getCatName());
  ...
  public void inOtherCatalog() throws TException {
    ...
    NotNullConstraintsRequest rqst = new NotNullConstraintsRequest(testTables[2].getDbName(), testTables[2].getTableName());
    ...
    rqst = new NotNullConstraintsRequest(testTables[2].getDbName(), testTables[2].getTableName());
    rqst.setCatName(testTables[2].getCatName());
    fetched = client.getNotNullConstraints(rqst);
    Assert.assertTrue(fetched.isEmpty());
  }
  ...
  public void deprecatedCalls() throws TException {
    ...
    NotNullConstraintsRequest rqst = new NotNullConstraintsRequest(testTables[0].getDbName(), testTables[0].getTableName());
    List<SQLNotNullConstraint> fetched = client.getNotNullConstraints(rqst);
    Assert.assertEquals(1, fetched.size());
    ...
    rqst = new NotNullConstraintsRequest(testTables[0].getDbName(), testTables[0].getTableName());
    fetched = client.getNotNullConstraints(rqst);
    Assert.assertTrue(fetched.isEmpty());
  }
  ...
  public void getNoSuchTable() throws TException {
    NotNullConstraintsRequest rqst =
        new NotNullConstraintsRequest(DEFAULT_DATABASE_NAME, "nosuch");
  ...
  public void getNoSuchDb() throws TException {
    NotNullConstraintsRequest rqst =
        new NotNullConstraintsRequest("nosuch", testTables[0].getTableName());
    rqst.setCatName(DEFAULT_CATALOG_NAME);
    List<SQLNotNullConstraint> nn = client.getNotNullConstraints(rqst);
    Assert.assertTrue(nn.isEmpty());
  }
  ...
  public void getNoSuchCatalog() throws TException {
    NotNullConstraintsRequest rqst =
        new NotNullConstraintsRequest(testTables[0].getTableName(), testTables[0].getTableName());
