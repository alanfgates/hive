...
public class InMemorySymLink extends InMemoryFile {
  ...
  @Override
  FileStatus stat() {
    return new FileStatus(0, false, 1, 1, getLastModificationTime(), getLastAccessTime(),
        getPerms(), getOwner(), getGroup(), linkTo.getPath(), getPath());
  }

  public InMemoryFile getLinkTo() {
    return linkTo;
  }
