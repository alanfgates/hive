...
module LockState
  ...
  TXN_ABORTED = 5
  RELEASED = 6
  VALUE_MAP = {1 => "ACQUIRED", 2 => "WAITING", 3 => "ABORT", 4 => "NOT_ACQUIRED", 5 => "TXN_ABORTED", 6 => "RELEASED"}
  VALID_VALUES = Set.new([ACQUIRED, WAITING, ABORT, NOT_ACQUIRED, TXN_ABORTED, RELEASED]).freeze
end
...
module LockType
  ...
  EXCLUSIVE = 3
  INTENTION = 4
  VALUE_MAP = {1 => "SHARED_READ", 2 => "SHARED_WRITE", 3 => "EXCLUSIVE", 4 => "INTENTION"}
  VALID_VALUES = Set.new([SHARED_READ, SHARED_WRITE, EXCLUSIVE, INTENTION]).freeze
end
